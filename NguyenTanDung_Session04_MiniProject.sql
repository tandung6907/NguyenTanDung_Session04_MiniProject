-- ============================================================
--   HỆ THỐNG HỌC TRỰC TUYẾN - ONLINE LEARNING SYSTEM
--   Tác giả: Generated by Claude
--   Mô tả: Script đầy đủ DDL + DML cho hệ thống QLHT
-- ============================================================
...
-- ============================================================
-- PHẦN II - NHẬP DỮ LIỆU BAN ĐẦU (DML - INSERT)
-- ============================================================

-- ------------------------------------------------------------
-- 2.1  Sinh viên (5 bản ghi)
-- ------------------------------------------------------------
...
-- ------------------------------------------------------------
-- 2.4  Phân công giảng viên phụ trách khóa học
-- ------------------------------------------------------------
...
-- ============================================================
-- PHẦN III - CẬP NHẬT DỮ LIỆU (DML - UPDATE)
-- ============================================================

-- 3.1  Cập nhật email cho sinh viên có student_id = 3 (Lê Minh Châu)
UPDATE Student
SET    email = 'chaule.updated@student.edu.vn'
WHERE  student_id = 3;

-- 3.2  Cập nhật mô tả cho khóa học Python (course_id = 1)
UPDATE Course
SET    description = 'Giới thiệu Python từ cơ bản đến nâng cao: cấu trúc dữ liệu, OOP, xử lý file và kết nối CSDL.'
WHERE  course_id = 1;

-- 3.3  Cập nhật điểm cuối kỳ cho sinh viên Nguyễn Văn An (student_id=1) môn CSDL (course_id=2)
UPDATE Result
SET    final_score = 8.5
WHERE  student_id = 1
  AND  course_id  = 2;
...
-- ============================================================
-- PHẦN IV - XÓA DỮ LIỆU (DML - DELETE)
-- ============================================================

-- 4.1  Xóa kết quả học tập tương ứng trước khi xóa đăng ký
--      (sinh viên 5 đã đăng ký nhầm khóa học 5 → xóa)
DELETE FROM Result
WHERE  student_id = 5
  AND  course_id  = 5;

-- 4.2  Xóa lượt đăng ký không hợp lệ (student_id=5, course_id=5)
...
-- ============================================================
-- PHẦN V - TRUY VẤN DỮ LIỆU (DML - SELECT)
-- ============================================================

-- 5.1  Danh sách tất cả sinh viên
SELECT
    student_id,
    full_name,
    birth_date,
...
-- 5.4  Thông tin đăng ký khóa học
